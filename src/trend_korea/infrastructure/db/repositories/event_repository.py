...
from trend_korea.domain.enums import Importance, VerificationStatus
...
class EventRepository:
    ...
    def list_saved_at_by_event_ids_for_user(self, *, user_id: str, event_ids: list[str]) -> dict[str, datetime]:
        if not event_ids:
            return {}
