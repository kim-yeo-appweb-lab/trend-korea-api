...
from src.schemas.sources import CreateSourceRequest
            ...
            "items": [
                {
                    ...
                    "publishedAt": source.published_at.isoformat(timespec="milliseconds").replace(
                        "+00:00", "Z"
                    ),
...
def create_source(
    payload: CreateSourceRequest, request: Request, db: DbSession, _: CurrentAdminUserId
):
    repo = SourceRepository(db)
    ...
    return success_response(
        ...
        data={
            ...
            "publishedAt": created.published_at.isoformat(timespec="milliseconds").replace(
                "+00:00", "Z"
            ),
