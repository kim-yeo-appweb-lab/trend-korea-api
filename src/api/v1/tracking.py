...
from src.schemas.shared import RESPONSE_401
from src.crud.events import EventService
from src.crud.issues import IssueService
from src.crud.tracking import TrackingService
...
def tracked_issues(
    ...
    sortBy: str = Query(
        default="trackedAt", description="정렬 기준 필드 (trackedAt, latestTriggerAt)"
    ),
):
